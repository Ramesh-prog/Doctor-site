    ...
    <footer className="text-center my-6 p-8 text-gray3">
      <div>
        ...
        <div className="flex justify-center items-center my-2">
          ...
          <a href='https://instagram.com/drbpsadangi?igshid=MzNlNGNkZWQ4Mg=='><i className="fab fa-instagram"></i></a>
          <a href='https://www.facebook.com/drbp.sadangi?mibextid=ZbWKwL'><i className="fab fa-facebook"></i></a>
        </div>
